...
var weatherInfo="<table id ='weatherinfo' style='border:2px solid; padding:60px;' align='center'>";
...
weatherInfo+="<tr> <td colspan='2'><img src='"+GetIcon(icon)+"' alt='"+GetIcon(icon)+"' title='"+summary+"' style=' display: block; margin: 0 auto; width:60%;' /></td></tr>";

weatherInfo+="<tr><td>Precipitation:</td>";
weatherInfo+="<td>"+GetPrecip(precipIntensity,Prec)+"</td></tr>";
...
weatherInfo+="<td>"+GetTime(SunRise.getHours(),SunRise.getMinutes())+"</td></tr>";
weatherInfo+="<tr><td>Sunset:</td>";
weatherInfo+="<td>"+GetTime(SunSet.getHours(),SunSet.getMinutes())+"</td></tr>";
weatherInfo+="</table>";
